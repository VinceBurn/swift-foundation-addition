#
#  Be sure to run `pod spec lint swift-foundation-addition.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.source_files  = "FoundationAdditionSources/*.{swift}", "FoundationAdditionSources/**/*.{swift}"
  s.exclude_files = "FoundationAdditionSources/Exclude"
